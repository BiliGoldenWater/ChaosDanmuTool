...
function createMainWindow(): void {
  ...
  mainWindow = new BrowserWindow({
    ...
    webPreferences: {
      preload: path.join(app.getAppPath(), "window_main_preload.js"),
    },
  });

  // and load the index.html of the app.

  mainWindow.loadURL(`http://localhost:${get("httpServerPort")}/main`).then();
}
...
export function createViewerWindow(): void {
  ...
  viewerWindow
    .loadURL(
      constructURL(
        `http://localhost:${get("httpServerPort")}/viewer`,
